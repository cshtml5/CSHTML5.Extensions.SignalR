(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.signalRNoJQueryBundle = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){

module.exports = require('./lib/jquery-deferred');
},{"./lib/jquery-deferred":4}],2:[function(require,module,exports){
...
},{"./jquery-core.js":3}],3:[function(require,module,exports){
/**
* jQuery core object.
*
...
},{"./jquery-callbacks.js":2}],5:[function(require,module,exports){
/**
...
var _signalrNoJquery = require('./src/signalR.js');

//var hubConnection=require('signalr-no-jquery');
//const connection = hubConnection('http://[address]:[port]', options);
/*module.exports={connection:function(url,hubproxyname)
{
  const connection = (0, _signalrNoJquery.hubConnection)(url);
  //import { connection } from 'signalr-no-jquery';


  const hubProxy = connection.createHubProxy(hubproxyname);

  // set up event listeners i.e. for incoming "message" event
  hubProxy.on('received', function (name,message) {
...
},{"./src/signalR.js":8}],7:[function(require,module,exports){
'use strict';
...
},{"jquery-deferred":1,"jquery-param":5}],8:[function(require,module,exports){
'use strict';
...
const hubConnection = exports.hubConnection = jQueryShim.hubConnection;
const signalR = exports.signalR = jQueryShim.signalR;
